...
class PatcherApi {
    ...
    after(id: string, object: any, method: string, callback: PatcherAfterCallback) {
        if(!validate("patcher.after", arguments, ["id", "string"], ["object", "object"], ["method", "string"], ["callback", "function"])) return;
    ...
    before(id: string, object: any, method: string, callback: PatcherBeforeCallback) {
        if(!validate("patcher.before", arguments, ["id", "string"], ["object", "object"], ["method", "string"], ["callback", "function"])) return;
    ...
    instead(id: string, object: any, method: string, callback: PatcherInsteadCallback) {
        if(!validate("patcher.instead", arguments, ["id", "string"], ["object", "object"], ["method", "string"], ["callback", "function"])) return;
...
class ScopedPatcherApi {
    ...
    after(object: any, method: string, callback: PatcherAfterCallback) {
        if(!validate("patcher.after", arguments, ["object", "object"], ["method", "string"], ["callback", "function"])) return;
